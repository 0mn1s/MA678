...
b_hat <- coef(fit_105b)
plot(kidiq$mom_age,kidiq$kid_score)
abline(b_hat[1], b_hat[2],col="red")
abline(b_hat[1] + b_hat[3], b_hat[2],col="blue")
...
plot(kidiq$mom_age,kidiq$kid_score)
abline(b_hat2[1] + b_hat2[3], b_hat[2] + b_hat2[4],col="red")
abline(b_hat2[1], b_hat2[2],col="blue")
...
ggplot(data = beauty, mapping = aes(beauty, eval)) +
  geom_point(size = 1) +
  geom_abline(intercept = coef(fit_106b)[1] +coef(fit_106b)[3], coef(fit_106b)[2], col = "red")+
    geom_abline(intercept = coef(fit_106b)[1], coef(fit_106b)[2], col = "red")
  theme_classic()
